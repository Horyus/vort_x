...
function BlocksFetchSaga(action) {
    var state, web3, block, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.select()];
            case 1:
                state = _a.sent();
                if (!ready_1.ready(state)) return [3 /*break*/, 8];
                web3 = state.vtxconfig.web3;
                _a.label = 2;
            case 2:
                _a.trys.push([2, 5, , 7]);
                return [4 /*yield*/, effects_1.call(web3.eth.getBlock, action.height)];
            case 3:
                block = _a.sent();
                return [4 /*yield*/, effects_1.put(actions_2.BlocksFetched(block.number, block))];
            case 4:
                _a.sent();
                return [3 /*break*/, 7];
            case 5:
                ...
                return [4 /*yield*/, effects_1.put(actions_1.VtxeventsAdd({
                        ...
                        e: e_1,
                        error_type: vtxevents_1.VtxeventErrorTypes.BlockFetchError
                    }))];
            case 6:
                _a.sent();
                return [3 /*break*/, 7];
...
exports.BlocksFetchSaga = BlocksFetchSaga;
//# sourceMappingURL=BlocksFetch.js.map