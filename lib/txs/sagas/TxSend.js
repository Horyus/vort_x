...
function TxSendSaga(action) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, effects_1.put(actions_2.TxAdd(tx_hash.transactionHash, action.tx_infos, action.tx_id))];
            case 5:
                _a.sent();
                return [3 /*break*/, 8];
            case 6:
...
exports.TxSendSaga = TxSendSaga;
//# sourceMappingURL=TxSend.js.map