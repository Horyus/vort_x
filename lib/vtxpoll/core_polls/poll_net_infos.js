...
exports.poll_net_infos = function (state, emit) { return __awaiter(void 0, void 0, void 0, function () {
    var web3, current_coinbase, _a, current_net;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                current_coinbase = _a.apply(void 0, [_b.sent()]);
                if (current_coinbase !== state.vtxconfig.coinbase) {
                    emit(actions_1.VtxconfigReset());
                    return [2 /*return*/];
                }
...
exports.poll_net_infos_interval = 10;
//# sourceMappingURL=poll_net_infos.js.map