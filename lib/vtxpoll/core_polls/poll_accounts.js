...
exports.poll_accounts = function (state, emit, new_block) { return __awaiter(void 0, void 0, void 0, function () {
    var web3, _a, _b, account, balance, _c, transaction_count, contract, code, e_1_1, _d, _e, account, balance, _f, transaction_count, contract, code, e_2_1;
    var e_1, _g, e_2, _h;
    return __generator(this, function (_j) {
        switch (_j.label) {
            ...
            case 3:
                balance = new (_c.apply(bignumber_js_1.BigNumber, [void 0, _j.sent()]))();
            ...
            case 12:
                ...
                _d = __values(Object.keys(state.accounts.accounts)), _e = _d.next();
                _j.label = 13;
            case 13:
                if (!!_e.done) return [3 /*break*/, 19];
                account = _e.value;
                _f = bignumber_js_1.BigNumber.bind;
                return [4 /*yield*/, web3.eth.getBalance(account)];
            case 14:
                balance = new (_f.apply(bignumber_js_1.BigNumber, [void 0, _j.sent()]))();
                return [4 /*yield*/, web3.eth.getTransactionCount(account)];
            case 15:
                transaction_count = _j.sent();
                contract = undefined;
