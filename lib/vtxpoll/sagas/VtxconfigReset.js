...
function loop(dispatcher, state_getter) {
    return __awaiter(this, void 0, void 0, function () {
        var e_2, _a, state, block_dependent, _b, _c, poll;
        var _this = this;
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (polling === null) {
                        polling = {};
                        try {
                            for (_b = __values(state.vtxpoll.actions), _c = _b.next(); !_c.done; _c = _b.next()) {
                                poll = _c.value;
...
function VtxconfigReset(dispatch, state_getter, action) {
...
exports.VtxconfigReset = VtxconfigReset;
