...
function VtxconfigResetSectionCompleteSaga(action) {
    var state, clear, web3, coinbase, tx_count, balance, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(action.section === 'vtxconfig')) return [3 /*break*/, 9];
            ...
            case 4:
                ...
                return [4 /*yield*/, effects_1.put(actions_2.AccountsAdd(coinbase, { alias: '@coinbase', permanent: false }))];
            case 5:
                _b.sent();
            ...
            case 6:
                _b.sent();
                _b.label = 7;
            case 7: return [4 /*yield*/, effects_1.put(actions_1.VtxconfigResetSectionComplete('accounts'))];
            case 8:
                _b.sent();
                _b.label = 9;
