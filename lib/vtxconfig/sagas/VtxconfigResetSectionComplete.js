...
function VtxconfigResetSectionComplete(action) {
    var state;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(state.vtxconfig.reset_status.txs
                    ...
                    && state.vtxconfig.reset_status.contracts)) return [3 /*break*/, 3];
                return [4 /*yield*/, effects_1.put(actions_1.VtxconfigResetComplete())];
            case 2:
                _a.sent();
                _a.label = 3;
...
exports.VtxconfigResetSectionComplete = VtxconfigResetSectionComplete;
