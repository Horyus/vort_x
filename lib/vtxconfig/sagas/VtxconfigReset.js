...
function VtxconfigResetSaga(action) {
    var state, clear, web3, coinbase, _a, net, genesis_hash;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                net = _b.sent();
                if (!(state.vtxconfig.allowed_nets !== null)) return [3 /*break*/, 8];
                if (!(state.vtxconfig.allowed_nets[net] === undefined)) return [3 /*break*/, 5];
                return [4 /*yield*/, effects_1.put(actions_1.VtxconfigSetStatus(vtxconfig_1.VtxStatus.WrongNet))];
            case 4:
                _b.sent();
                return [2 /*return*/];
            case 5: return [4 /*yield*/, effects_1.call(web3.eth.getBlock, 0)];
            case 6:
                genesis_hash = (_b.sent()).hash.toLowerCase();
                if (!(state.vtxconfig.allowed_nets[net].toLowerCase() !== genesis_hash)) return [3 /*break*/, 8];
                return [4 /*yield*/, effects_1.put(actions_1.VtxconfigSetStatus(vtxconfig_1.VtxStatus.WrongNet))];
            case 7:
                _b.sent();
                return [2 /*return*/];
            case 8: return [4 /*yield*/, effects_1.put(actions_1.VtxconfigSetInfos(coinbase, net))];
            case 9:
                _b.sent();
                _b.label = 10;
            case 10: return [4 /*yield*/, effects_1.put(actions_1.VtxconfigResetSectionComplete('vtxconfig'))];
            case 11:
                _b.sent();
                return [2 /*return*/];
        }
...
//# sourceMappingURL=VtxconfigReset.js.map