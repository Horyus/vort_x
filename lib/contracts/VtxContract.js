...
var VtxContract = /** @class */ (function () {
    function VtxContract(store, name, address, abi, bin, constructor_bin) {
        var _this = this;
        this._methods = {};
        this._events = {};
            ...
            var _loop_1 = function (method) {
                if (method.type === 'function' && method.constant === false) {
                    _this._methods[method.name] = function () {
                        ...
                        _this._store.dispatch(actions_2.ContractsSend(function () { return __awaiter(_this, void 0, void 0, function () {
                            var coinbase, splitted_args, res;
                            var _a, _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0: return [4 /*yield*/, this._store.getState().vtxconfig.coinbase];
                                    case 1:
                                        coinbase = _c.sent();
                ...
                if (method.type === 'function' && method.constant === true) {
                    ...
                    _this._methods[method.name] = function () {
                        ...
                        if (cache === undefined) {
                            ...
                            _this._store.dispatch(actions_1.VtxcacheCreate(sig, cb));
                        }
                        else if (cache.required === false) {
                            _this._store.dispatch(actions_1.VtxcacheSetRequired(sig));
                        }
            ...
            var _loop_3 = function (event_1) {
                if (event_1.type === 'event') {
                    _this._events[event_1.name] = function (args) {
                        ...
                        var state = _this._store.getState();
                        var followed = state.events.followed[sig];
                        if (followed === undefined) {
                            _this._store.dispatch(actions_3.EventsFollow(event_1.name, args, _this._name, _this._address, sig));
                            return [];
                        }
        ...
        var web3 = store.getState().vtxconfig.web3;
        this._store = store;
    ...
    Object.defineProperty(VtxContract.prototype, "valid", {
        get: function () {
            ...
            if (!state.contracts.instances[this._name][this._address])
                return null;
