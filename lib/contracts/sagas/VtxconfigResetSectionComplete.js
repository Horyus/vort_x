...
function BuildWeb3Instances(clear) {
    var state, _a, _b, contract, _c, _d, instance, e_3_1, e_4_1;
    var e_4, _e, e_3, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0: return [4 /*yield*/, effects_1.select()];
            ...
            case 4:
                ...
                _c = (e_3 = void 0, __values(Object.keys(state.contracts.instances[contract]))), _d = _c.next();
                _g.label = 5;
            case 5:
                if (!!_d.done) return [3 /*break*/, 8];
                instance = _d.value;
                return [4 /*yield*/, effects_1.put(actions_1.ContractsSetWeb3Instance(contract, instance, clear))];
            case 6:
                _g.sent();
                _g.label = 7;
            case 7:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, effects_1.call(BuildWeb3Instances, clear)];
            case 4:
                _a.sent();
                return [4 /*yield*/, effects_1.call(ValidateInstances)];
            case 5:
                _a.sent();
                _a.label = 6;
