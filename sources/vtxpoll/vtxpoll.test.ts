import { applyMiddleware, compose, createStore, Dispatch, Reducer, Store } from 'redux';
...
import { VtxpollAdd, VtxpollKill }              from '../vtxpoll/actions/action';
import * as Fs                                  from 'fs';
import { vtx_status }                           from '../test_tools';
import { VtxStatus }                            from '../state/vtxconfig';
import { VtxconfigReset, VtxconfigSetWeb3 }     from '../vtxconfig/actions/actions';
